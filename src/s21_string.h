...
char *s21_strcat(char *first, const char *second);
char *s21_strncat(char *first, const char *second, s21_size_t n);
...
void s21_reverse(char s[]);
    ...
    #define N 133
    #define ERROR {"Success", "Operation not permitted", "No such file or directory",               \
